import cv2
from ultilities import get_contours, warp_image, calculate_distance, reorder_corner_points
...
if len(contours) != 0:
    ...
    warp_img = warp_image(test_img, biggest_rect, width=scale*w_a4, height=
                          scale*h_a4)
...
display_test = cv2.resize(test_img, None, fx=0.35, fy=0.35, interpolation=cv2.INTER_AREA)
